...
import BasicTable from "../../../components/Tables/BasicTable/index";
...
const UsersList = () => {
  const {
    ...
    methods: { navigate, onFilter, onPageChange, onSortBy, onSearch },
  } = useUsersList();
      ...
      <section className="antialiased">
        <div className="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 pb-4">
          <div className="w-full md:w-1/2">
            <h4 className="font-semibold">Users List</h4>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4">
            <div className="flex w-full md:w-1/2">
              <BasicTextInput
                ...
                id="searchUsers"
                name="search_users"
                iconStart={<Search sx={{ color: "#0089ff", fontSize: 20 }} />}
                type="search"
                className="w-1/2"
                onChange={onSearch}
              />
